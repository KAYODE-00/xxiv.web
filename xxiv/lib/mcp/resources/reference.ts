...
const EXAMPLE_PROMPTS = {
  description: 'Example prompts and tool usage patterns for common XXIV tasks',
  quick_start: {
...
export function registerReferenceResources(server: McpServer) {
  ...
  server.resource(
    'design-reference',
    'xxiv://reference/design-properties',
    {
    ...
    async () => ({
      contents: [{
        uri: 'xxiv://reference/design-properties',
        mimeType: 'application/json',
        text: JSON.stringify({
