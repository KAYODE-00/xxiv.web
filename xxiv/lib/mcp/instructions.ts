...
# XXIV — AI Agent Design Guide

You are an AI agent connected to XXIV, a visual website builder. You can create pages,
...
XXIV has a built-in CMS. Collections are like database tables:
...
XXIV has 48 professionally designed layout templates. **ALWAYS use these instead of building from scratch.**
