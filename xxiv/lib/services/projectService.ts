 ...
 * Project Service
 *
 * Handles exporting and importing project data as portable .xxiv dumps.
 */
...
/** 4-byte magic header to identify encrypted .xxiv files. */
...
/**
 * Pack export data into a .xxiv file buffer.
...
/**
 * Unpack a .xxiv file buffer into export data.
...
const DEFAULT_PROJECT_NAME = 'xxiv-app';
...
/** Generate a filename for a .xxiv export from the manifest. */
