...
export const useComponentsStore = create<ComponentsStore>((set, get) => {
  ...
  return {
    ...
    updateComponent: async (id, updates) => {
      ...
      try {
        const response = await fetch(`/xxiv/api/components/${id}`, {
          method: 'PUT',
          headers: { 'Content-Type': 'application/json' },
    ...
    saveComponentDraft: async (componentId) => {
      ...
      try {
        const response = await fetch(`/xxiv/api/components/${componentId}`, {
          method: 'PUT',
          headers: { 'Content-Type': 'application/json' },
      ...
      for (const componentId of componentIds) {
        try {
          ...
          if (!result.data || result.error) {
            ...
            const restoreResponse = await fetch(`/xxiv/api/components/${componentId}`, {
              method: 'PATCH',
              headers: { 'Content-Type': 'application/json' },
