...
const INTEGRATIONS_ITEMS = [
  { id: 'apps', label: 'Apps', path: '/xxiv/integrations/apps' },
  { id: 'webhooks', label: 'Webhooks', path: '/xxiv/integrations/webhooks' },
  { id: 'api', label: 'Xxiv API', path: '/xxiv/integrations/api' },
  { id: 'mcp', label: 'MCP', path: '/xxiv/integrations/mcp' },
];
