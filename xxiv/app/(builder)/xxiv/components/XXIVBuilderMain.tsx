 ...
 * - /xxiv (base route)
 * - /xxiv/pages/[id]/edit (page settings)
 * - /xxiv/pages/[id]/layers (page layers)
 * - /xxiv/collections/[id] (collections)
...
interface XXIVBuilderProps {
  children?: React.ReactNode;
}

export default function XXIVBuilder({ children }: XXIVBuilderProps = {} as XXIVBuilderProps) {
