...
export default function ProfilePage() {
  ...
  const handlePhotoUpload = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const response = await fetch('/xxiv/api/profile/avatar', {
        method: 'POST',
        body: formData,
      });
  ...
  const handleSaveName = async () => {
    ...
    try {
      const response = await fetch('/xxiv/api/profile/name', {
        method: 'PUT',
  ...
  const handleSaveEmail = async () => {
    ...
    try {
      const response = await fetch('/xxiv/api/profile/email', {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
  ...
  const handleSavePassword = async () => {
    ...
    try {
      const response = await fetch('/xxiv/api/profile/password', {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
  ...
  const handleDeleteProfile = async () => {
    ...
    try {
      const response = await fetch('/xxiv/api/profile', {
        method: 'DELETE',
      });
