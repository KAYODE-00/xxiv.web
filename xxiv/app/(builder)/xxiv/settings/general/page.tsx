...
export default function GeneralSettingsPage() {
  ...
  // Initialize Xxiv badge from store
  const storedXxivBadge = getSettingByKey('xxiv_badge') as boolean | null;
  const [xxivBadge, setXxivBadge] = useState(storedXxivBadge ?? true);
  ...
  const handleSitemapTabChange = useCallback((tab: string) => {
    const mode: SitemapMode = tab === 'xxiv-sitemap'
      ? 'auto'
      : tab === 'custom-sitemap'
        ? 'custom'
        : 'none';
  ...
  const handleResetProject = useCallback(async () => {
    try {
      ...
      const response = await fetch('/xxiv/api/devtools/reset-db', {
        method: 'POST',
      });
            ...
            <div className="grid grid-cols-3 gap-10 bg-secondary/20 p-8 rounded-lg">
              ...
              <div className="col-span-2 grid grid-cols-2 gap-5">
                ...
                <Field orientation="horizontal" className="flex-row-reverse col-span-2">
                  <FieldContent>
                    <FieldLabel htmlFor="badge">Display the &ldquo;Made in Xxiv&rdquo; badge</FieldLabel>
                    <FieldDescription>
                      {isCloudVersion()
                        ? 'Upgrade to a project plan in order to disable the badge.'
                        : 'Help support Xxiv by displaying this badge on your website.'}
                    </FieldDescription>
                  </FieldContent>
                  <Switch
                    id="badge"
                    checked={xxivBadge}
                    onCheckedChange={setXxivBadge}
                  />
                </Field>
            ...
            <div className="grid grid-cols-3 gap-10 bg-secondary/20 p-8 rounded-lg">
              ...
              <div className="col-span-2 grid grid-cols-2 gap-8">
                <Field className="col-span-2">
                  ...
                  <FieldDescription>
                    Seamlessly integrate Google Analytics into your Xxiv site. As the site owner, you are responsible for ensuring your site complies with privacy regulations, such as GDPR, and handles data appropriately.
                  </FieldDescription>
                  <Input
                ...
                <Field className="col-span-2">
                  ...
                  <Tabs value={activeSeoTab} onValueChange={handleSitemapTabChange}>
                    <TabsList className="w-full">
                      ...
                      <TabsTrigger value="xxiv-sitemap">Xxiv generated</TabsTrigger>
                    ...
                    <TabsContent value="xxiv-sitemap" className="mt-4 space-y-6">
                      <p className="text-sm text-muted-foreground">
