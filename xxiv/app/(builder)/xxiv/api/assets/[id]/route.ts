...
export async function PUT(
  ...
  try {
    ...
    console.error('[PUT /xxiv/api/assets/[id]] Error:', error);
...
export async function DELETE(
  ...
  try {
    ...
    console.error('[DELETE /xxiv/api/assets/[id]] Error:', error);
