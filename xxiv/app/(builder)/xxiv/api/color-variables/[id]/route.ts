...
/**
 * PUT /xxiv/api/color-variables/[id]
 */
export async function PUT(
  ...
  try {
    ...
    console.error('[PUT /xxiv/api/color-variables/[id]] Error:', error);
...
/**
 * DELETE /xxiv/api/color-variables/[id]
 */
export async function DELETE(
  ...
  try {
    ...
    console.error('[DELETE /xxiv/api/color-variables/[id]] Error:', error);
