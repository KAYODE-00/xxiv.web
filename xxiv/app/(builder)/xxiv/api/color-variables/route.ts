...
export async function GET() {
  try {
    ...
    console.error('[GET /xxiv/api/color-variables] Error:', error);
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('[POST /xxiv/api/color-variables] Error:', error);
