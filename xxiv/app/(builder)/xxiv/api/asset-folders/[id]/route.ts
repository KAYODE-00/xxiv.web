...
export async function GET(
  ...
  try {
    ...
    console.error('[GET /xxiv/api/asset-folders/[id]] Error:', error);
...
export async function PUT(
  ...
  try {
    ...
    console.error('[PUT /xxiv/api/asset-folders/[id]] Error:', error);
...
/**
 * DELETE /xxiv/api/asset-folders/[id]
 *
...
export async function DELETE(
  ...
  try {
    ...
    console.error('[DELETE /xxiv/api/asset-folders/[id]] Error:', error);
