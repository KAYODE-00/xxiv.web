...
export async function GET() {
  try {
    ...
    console.error('[GET /xxiv/api/asset-folders] Error:', error);
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('[POST /xxiv/api/asset-folders] Error:', error);
