...
export async function GET(
  ...
  try {
    ...
    console.error('[GET /xxiv/api/folders/[id]] Error:', error);
...
export async function PUT(
  ...
  try {
    ...
    console.error('[PUT /xxiv/api/folders/[id]] Error:', error);
...
export async function DELETE(
  ...
  try {
    ...
    console.error('[DELETE /xxiv/api/folders/[id]] Error:', error);
